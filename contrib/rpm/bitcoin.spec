...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 44684
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 44688
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 44684
	%{_sbindir}/semanage port -d -p tcp 44688
