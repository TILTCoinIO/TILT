...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tilt-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tilt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tilt transaction") + "\n" +
              "  tilt-tx [options] -create [commands]   " + _("Create hex-encoded tilt transaction") + "\n" +
              "\n";
