...
const char * const BITCOIN_CONF_FILENAME = "tilt.conf";
const char * const BITCOIN_PID_FILENAME = "tilt.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TILT";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TILT";
#else
    // Unix
    return pathRet / ".tilt";
#endif
